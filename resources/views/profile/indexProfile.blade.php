        ...
        <div class="pt-4 mt-4 flex flex-col items-center text-center">
            ...
            @if (session('success'))
                <div id="success-alert"
                    class="alert bg-blue-100 border border-blue-400 text-pink-500 px-4 py-3 rounded relative text-center font-bold mt-8 transition-all duration-200 transform">
                    {{ session('success') }}
                </div>
                <script>
