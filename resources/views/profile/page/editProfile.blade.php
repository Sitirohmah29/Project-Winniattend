    ...
    <form method="POST" action="{{ route('profile.update') }}" enctype="multipart/form-data">
        ...
        <div class="flex justify-center items-center">
            <div class="flex relative w-fit mt-10">
                ...
                <label for="profile_photo"
                    class="fa-solid fa-pen-to-square absolute bottom-1 right-1 p-2 bg-blue-500 text-white rounded-full cursor-pointer hover:bg-blue-600 transition-colors">
        ...
        <div class="grid gap-5">
            <div class="grid gap-2">
                ...
                <input class="input" id="fullname" name="fullname" value="{{ old('fullname', $user->fullname) }}">
                @error('name')
