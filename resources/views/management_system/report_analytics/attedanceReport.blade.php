...
<head>
    ...
    <title>Managemet - Attedance Report</title>
</head>
            ...
            <!-- Header -->
                ...
                <div class="flex flex-row gap-4 items-center justify-between" >
                    <div class="flex flex-row items-center gap-3">
                        <div class="px-3 py-2 rounded-full shadow-lg cursor-pointer" onclick="window.location.href='{{ url('/indexReport') }}'">
                    ...
                    <table class="min-w-full bg-white">
                        <thead>
                            <tr class="bg-blue-500 text-white text-left text-sm">
                                ...
                                <th class="px-4 py-3 font-semibold text-center">Total Overtime</th>
                        ...
                        <tbody class="text-sm text-gray-700">
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-4 py-2">176 hours</td>
                            </tr>
                            <tr class="hover:bg-gray-50">
                                <td class="px-4 py-2">John Doe</td>
                                <td class="px-4 py-2">Fullstack Developer</td>
