                ...
                <table class="min-w-full bg-white">
                    ...
                    <tbody class="text-sm text-gray-700">
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-4 py-2 underline" onclick="window.location.href='{{ url('/checkinAttedance') }}'">08:05 AM</td>
                            <td class="px-4 py-2 underline">05:00 PM</td>
                            <td class="px-4 py-2">8h 55m</td>
                        ...
                        <tr class=" hover:bg-gray-50">
                            <td class="px-4 py-2">Risma Handayani</td>
                            <td class="px-4 py-2">Laravel Developer</td>
                            <td class="px-4 py-2">2025-03-21</td>
                            <td class="px-4 py-2 underline">08:05 AM</td>
                            <td class="px-4 py-2 underline">05:00 PM</td>
                            <td class="px-4 py-2">8h 55m</td>
                            <td class="px-4 py-2">On time</td>
                            <td class="px-4 py-2 text-blue-500">
                        ...
                        <tr class=" hover:bg-gray-50">
                            <td class="px-4 py-2">Siti Rohmah</td>
                            <td class="px-4 py-2">Fullstack Developer</td>
                            <td class="px-4 py-2">2025-03-21</td>
                            <td class="px-4 py-2 underline">08:05 AM</td>
                            <td class="px-4 py-2 underline">05:00 PM</td>
                            <td class="px-4 py-2">8h 55m</td>
                            <td class="px-4 py-2">Late</td>
                            <td class="px-4 py-2 text-blue-500">
                                <i class="fa-solid fa-pen-to-square"></i>
                            </td>
                        </tr>
