        ...
        <div class="content flex flex-col gap-6 ml-58 p-6 w-full overflow-y-auto">
            ...
            <div class="flex gap-4 items-center justify-between">
                ...
                <div class="flex items-center bg-white rounded-full shadow-md px-4 py-2 w-[800px]">
                    ...
                    <input type="text" placeholder="Search" class="w-full bg-transparent outline-none text-base italic text-gray-700"/>
                </div>
                ...
                <div x-data="{ open: false, selected: 'January', months: ['January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'December'] }" class="relative">
                    <button @click="open = !open" class="flex items-center bg-white rounded-full shadow-md px-4 py-2 cursor-pointer w-[150px] justify-between">
                ...
                <table class="min-w-full bg-white">
                    <thead>
                        <tr class="bg-blue-500 text-white text-left text-sm">
                            ...
                            <th class="px-4 py-3 font-semibold">Acces Right</th>
                    ...
                    <tbody class="text-sm text-gray-700">
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-4 py-2">081413225122</td>
                            <td class="px-4 py-2 ">Fullstack Developer</td>
                            <td class="px-4 py-2 ">Shift 1</td>
                            ...
                            <td class="px-4 py-2">
                                <div class="flex flex-row gap-2 items-center">
                                    ...
                                    <i class="fa-solid fa-rotate-right" style="color : gray"></i>
                                </div>
                            </td>
                        </tr>
                        <tr class="hover:bg-gray-50">
            ...
            <div class="flex flex-row justify-end gap-3 text-blue-500 items-center-safe">
                <button class="text-lg font-semibold">See more</button>
                <i class="fa-solid fa-angle-right fa-lg"></i>
            </div>

            {{-- form add user --}}
            <div class="ml-30 mb-10 max-w-3xl bg-white p-8 rounded-3xl shadow-xl">
                <h2 class="text-center text-3xl font-bold text-gray-800 mb-6">Added User</h2>

                <form class="flex flex-col gap-4">
                    <!-- Input Fullname -->
                    <div>
                        <label class="block mb-1 text-base font-medium text-gray-700">Fullname</label>
                        <input type="text" class="w-full px-4 py-2 rounded-md bg-pink-100 focus:outline-none" />
                    </div>

                    <!-- Input Email -->
                    <div>
                        <label class="block mb-1 text-base font-medium text-gray-700">E-mail</label>
                        <input type="email" class="w-full px-4 py-2 rounded-md bg-pink-100 focus:outline-none" />
                    </div>
                    ...
                    <div>
                        ...
                        <input type="password" class="w-full px-4 py-2 rounded-md bg-pink-100 focus:outline-none" />
                    </div>

                    <!-- Grid for Position, Shift, Status, Access Rights -->
                    <div class="mt-10 grid grid-cols-2 gap-4">
                        <div>
                            <label class="block mb-1 text-base font-medium text-gray-700">Position</label>
                            <select class="w-full px-4 py-2 rounded-md bg-pink-100 focus:outline-none">
                        ...
                        <div>
                            <label class="block mb-1 text-base font-medium text-gray-700">Access Rights</label>
                            <select class="w-full px-4 py-2 rounded-md bg-pink-100 focus:outline-none">
                    ...
                    <div class="flex justify-center gap-4 mt-6">
                        <button type="reset" class="bg-gray-600 w-xs text-white px-6 py-2 rounded-md hover:bg-gray-700">Reset</button>
                        <button type="submit" class="bg-blue-500 w-xs text-white px-6 py-2 rounded-md hover:bg-blue-600">Add</button>
                    </div>
                </form>
            </div>
        </div>
