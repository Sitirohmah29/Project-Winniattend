    ...
    <div class="dashboard flex flex-row max-w-screen ">
        ...
        <div class="navbar fixed left-0 top-0 h-full flex flex-col justify-start bg-white shadow-lg px-6 py-8 w-58 z-10">
            ...
            <div class="nav-list flex flex-col gap-4" >
                ...
                <div class="management-user flex flex-row gap-2 items-center" onclick="window.location.href='{{ url('/indexManagUser')}}'">
        ...
        <div class="content flex flex-col gap-6 ml-58 p-6 w-full overflow-y-auto">
            ...
            <div class="statistics flex flex-col items-center gap-4">
                <h3 class="text-xl text-gray-600 text-center">Employee Attendance Statistics</h3>
            ...
            <div class="flex flex-row justify-between">
                ...
                <div class="bg-white flex flex-col w-[450px] h-auto gap-4 items-start p-6 rounded-2xl shadow-lg">
                    ...
                    <div class="w-full space-y-3">
                        <div class="flex flex-row w-full justify-between items-center py-2">
                            <span class="text-base text-black font-medium">1. Eko Kurniawan</span>
                            <span class="text-sm text-gray-500">26 days - 96% On Time - 208 hours</span>
                        </div>
                        <div class="flex flex-row w-full justify-between items-center py-2">
                            <span class="text-base text-black font-medium">2. Risma Handayani</span>
                            <span class="text-sm text-gray-500">25 days - 88% On Time - 200 hours</span>
                        </div>
                        <div class="flex flex-row w-full justify-between items-center py-2">
                            <span class="text-base text-black font-medium">3. Siti Rohmah</span>
                            <span class="text-sm text-gray-500">24 days - 95% On Time - 192 hours</span>
                        </div>
                        <div class="flex flex-row w-full justify-between items-center py-2">
                            <span class="text-base text-black font-medium">4. Andi Satrio</span>
                            <span class="text-sm text-gray-500">23 days - 90% On Time - 184 hours</span>
                        </div>
                        <div class="flex flex-row w-full justify-between items-center py-2">
                            <span class="text-base text-black font-medium">5. Dinda Kirana</span>
                            <span class="text-sm text-gray-500">22 days - 92% On Time - 176 hours</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white flex flex-col gap-4 items-center justify-between p-6 rounded-2xl shadow-lg min-w-[220px]">
                    ...
                    <div class="text-4xl font-bold text-black text-center pb-30">12:36:02</div>
                </div>
            </div>
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-blue-600">
                            <tr>
                                ...
                                <th class="px-6 py-4 text-left text-lg font-semibold text-white">Idle Time</th>
                            </tr>
                        </thead>
                        <tbody class="bg-white divide-y divide-gray-100">
                            <tr class="hover:bg-gray-50">
                                <td class="px-6 py-4 text-gray-800 font-medium">Risma Handayani</td>
                            ...
                            <tr class="hover:bg-gray-50">
                                <td class="px-6 py-4 text-gray-800 font-medium">Siti Rohmah</td>
                                <td class="px-6 py-4 text-gray-600">08:15 AM</td>
                                <td class="px-6 py-4 text-gray-600">04:45 PM</td>
                                <td class="px-6 py-4 text-gray-600">45 min</td>
                            </tr>
                            <tr class="hover:bg-gray-50">
                                <td class="px-6 py-4 text-gray-800 font-medium">John Doe</td>
                                <td class="px-6 py-4 text-gray-600">07:45 AM</td>
                                <td class="px-6 py-4 text-gray-600">05:10 PM</td>
                                <td class="px-6 py-4 text-gray-600">20 min</td>
                            </tr>
                            <tr class="hover:bg-gray-50">
                                <td class="px-6 py-4 text-gray-800 font-medium">Jane Smith</td>
                                <td class="px-6 py-4 text-gray-600">08:20 AM</td>
                                <td class="px-6 py-4 text-gray-600">05:00 PM</td>
                                <td class="px-6 py-4 text-gray-600">35 min</td>
                            </tr>
                            <tr class="hover:bg-gray-50">
                                <td class="px-6 py-4 text-gray-800 font-medium">Emily Carter</td>
                                <td class="px-6 py-4 text-gray-600">08:10 AM</td>
                                <td class="px-6 py-4 text-gray-600">04:50 PM</td>
                                <td class="px-6 py-4 text-gray-600">40 min</td>
                            </tr>
                            <tr class="hover:bg-gray-50">
                                <td class="px-6 py-4 text-gray-800 font-medium">Eko Kurniawan</td>
                                <td class="px-6 py-4 text-gray-600">07:50 AM</td>
                                <td class="px-6 py-4 text-gray-600">05:15 PM</td>
                                <td class="px-6 py-4 text-gray-600">25 min</td>
                            </tr>
                            <tr class="hover:bg-gray-50">
                                <td class="px-6 py-4 text-gray-800 font-medium">Andi Satrio</td>
                                <td class="px-6 py-4 text-gray-600">08:05 AM</td>
                                <td class="px-6 py-4 text-gray-600">05:00 PM</td>
                                <td class="px-6 py-4 text-gray-600">30 min</td>
                            </tr>
                            <tr class="hover:bg-gray-50">
                                <td class="px-6 py-4 text-gray-800 font-medium">Dinda Kirana</td>
                                <td class="px-6 py-4 text-gray-600">08:25 AM</td>
                                <td class="px-6 py-4 text-gray-600">04:55 PM</td>
                                <td class="px-6 py-4 text-gray-600">35 min</td>
                            </tr>
                        </tbody>
                    </table>
