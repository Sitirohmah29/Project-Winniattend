        ...
        <div class="content flex flex-col gap-6 ml-58 p-6 w-full overflow-y-auto">
            ...
            <div class="flex flex-row justify-between items-center">
                ...
                <div class="rounded-full bg-black p-3" onclick="window.location.href='{{ url('/notificationWeb') }}'">
                    <svg width="24" height="24" viewBox="0 0 26 31" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <path
            ...
            <div class="flex flex-row justify-between">
                ...
                <!-- Employee Count -->
                <div
                    class="bg-white flex flex-col gap-4 w-[280px] h-auto items-center justify-between p-6 rounded-2xl shadow-lg">
                ...
                <!-- Overtime -->
                <div
                    class="bg-white flex flex-col gap-4 items-center justify-between p-6 rounded-2xl shadow-lg min-w-[220px]">
