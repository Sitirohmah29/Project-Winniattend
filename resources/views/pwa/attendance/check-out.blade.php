...
<body class="bg-white font-sans">
    <div class="flex flex-col h-screen">
        ...
        <!-- Map Section (Realtime Info) -->
        <div id="map" class="w-full h-80 rounded-md relative">
            <div id="location-info"
                class="absolute bottom-5 left-2 bg-white bg-opacity-90 rounded-md shadow p-3 z-[500] max-w-xs">
                ...
                <div class="flex items-start">
                    ...
                    <div class="ml-3">
                        <h3 class="text-sm font-semibold" id="locationName">Mendeteksi lokasi...</h3>
                        <p class="text-xs font-thin" id="locationAddress">
                            Mendeteksi alamat...
                        </p>
                    </div>
                </div>
        ...
        <div class="flex justify-center mt-8">
            <form id="punchOutForm" method="POST" action="{{ route('attendance.realtime') }}"
                ...
                <button type="button" id="scanFaceBtn" onclick="doFaceCheckOut()"
                    class="w-32 h-32 flex items-center justify-center hover:scale-105 transition-transform duration-200">
                    <div class="flex items-center justify-center">
                        <svg width="123" height="124" viewBox="0 0 123 124" fill="none"
                            ...
                            <g clip-path="url(#clip0_2514_308)">
                                <path
                                    d="M79.3539 85.4769V75.5614C79.3539 74.3788 79.1209 73.2078 78.6684 72.1152C78.2158 71.0226 77.5525 70.0298 76.7162 69.1936C75.88 68.3573 74.8872 67.694 73.7946 67.2414C72.702 66.7888 71.531 66.5559 70.3484 66.5559H62.5294V51.9399C62.5294 49.6159 60.6429 47.7329 58.3224 47.7329C55.9984 47.7329 54.1119 49.6159 54.1119 51.9399V71.0989L52.7119 71.3614C51.7289 71.5457 50.8076 71.9726 50.0316 72.6035C49.2556 73.2343 48.6495 74.0491 48.2684 74.9737C47.8873 75.8983 47.7432 76.9035 47.8493 77.8979C47.9554 78.8923 48.3083 79.8445 48.8759 80.6679L49.4394 81.4869L52.1834 85.4769"
                                    stroke="black" stroke-width="4" stroke-linecap="round" stroke-linejoin="round" />
                                <path
                                    d="M46.0897 55.4889C45.6583 53.6352 45.6511 51.708 46.0687 49.8511C46.4862 47.9943 47.3178 46.2557 48.5013 44.7651C49.6847 43.2746 51.1896 42.0706 52.9034 41.2429C54.6173 40.4153 56.496 39.9855 58.3992 39.9855C60.3025 39.9855 62.1812 40.4153 63.895 41.2429C65.6089 42.0706 67.1138 43.2746 68.2972 44.7651C69.4807 46.2557 70.3123 47.9943 70.7298 49.8511C71.1474 51.708 71.1402 53.6352 70.7087 55.4889"
                                    stroke="black" stroke-width="4" stroke-linecap="round" stroke-linejoin="round" />
                            </g>
                            <defs>
                                <clipPath id="clip0_2514_308">
                                    <rect width="49" height="49" fill="white"
                                        transform="translate(37 38.2269)" />
                                </clipPath>
                            </defs>
                        </svg>
                    </div>
            ...
            <div class="text-center">
                ...
                <div class="flex justify-center">
                    <button onclick="closePopup()"
                        class="px-6 py-2 bg-blue-500 text-white rounded-lg hover:bg-pink-600 transition-colors font-semibold">
                        OK
                    </button>
                </div>
            </div>
    ...
    <script>
        ...
        const officeLat = -6.596300;
        const officeLng = 106.806039;
        ...
        document.addEventListener("DOMContentLoaded", function() {
            if (navigator.geolocation) {
                navigator.geolocation.getCurrentPosition(function(position) {
                    ...
                    // Inisialisasi peta & lokasi awal
                    initMap(lat, lng);
                    fetchLocationName(lat, lng);
                    // Watch posisi user secara realtime
                    navigator.geolocation.watchPosition(function(pos) {
                        const newLat = pos.coords.latitude;
                        const newLng = pos.coords.longitude;
                        document.querySelector('input[name="latitude"]').value = newLat;
                        document.querySelector('input[name="longitude"]').value = newLng;
