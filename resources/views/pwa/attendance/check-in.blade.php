...
<body class="bg-white font-poppins">
    ...
    <div id="faceIdPopup"
        class="popup-overlay mt-15 fixed top-0 left-0 right-0 inset-0 bg-opacity-50 flex items-center justify-center z-[9999] mb-150"
        style="display: none;">
